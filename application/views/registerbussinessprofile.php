...
<select id="choose-profile-for-register" onchange="getval(this);">
	<option value="bussinessprofile" selected="selected">Register New Bussiness Profile</option>
...
<div class="container">
    <div  class="span7 offset2">
        <div id="upload-img">
            ...
            <?php echo form_open_multipart('/upload/registerbussiness/', array('id' => 'fileupload')); ?>
