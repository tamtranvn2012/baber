<div class="container">
    <div class="row">
        ...
        <div  class="span8 well" id="form-control-addnewcontent" style="margin-left: 10px;" >
            ...
            echo form_open_multipart('/upload/uploadbipost', array('id' => 'fileupload')); ?>
            <div class="span7">
            ...
            <div class="span7">
                ...
                <div class="span5"><input type="text" name="tags" value="" class="form-control"/>
                    <input type="hidden" name="upidpost" value="<?php echo $upidpost;?>" />
            ...
            <input class="btn btn-success offset2" name="addnewbipost" type="submit" value="Submit"/>
